...
// Same layout, content and behavior as the real homepage (app/page.tsx) —
...
export default function Index3({ posts }: { posts: Post[] }) {
  ...
  return (
    <main className="idx3-page">
        ...
        <div className="hero-inner">
          ...
          <div className="hero-visual">
            <div className="hero-logo-display">
              ...
              <LogoWhite width={340} height={340} uid="idx3hero" />
            </div>
          </div>
        </div>
      ...
      {/* CLIENT LOGOS — same seam-badge + big bold marquee treatment as
          /index2's "trusted by" section. */}
      <div className="idx3-seam-badge" aria-hidden="false">
        <span className="idx3-crystal-badge">Trusted by brands across Dubai, GCC and beyond</span>
      </div>
      <section id="clients">
        <div className="idx3-trusted-viewport">
          <div className="idx3-trusted-track">
            {[...TRUSTED_BRANDS, ...TRUSTED_BRANDS].map((name, i) => (
              <span key={i} className="idx3-trusted-item">{name}</span>
            ))}
          </div>
        </div>
      </section>
